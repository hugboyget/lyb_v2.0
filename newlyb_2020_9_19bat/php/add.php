...
if(!$re){
	die('<script>alert("Error:MayBe your Title words too long ! ");location.href="../home.php";</script>'.mysql_error());
}
else{
	echo $uname;
	echo"<script>alert('Post Success !');location.href='../home.php'</script>";
}
