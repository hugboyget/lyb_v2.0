    ...
    <div class="container">
	    <div class="row clearfix">
	        ...
	        <div class="col-md-6 column">
               ...
               <div>
               &nbsp;&nbsp;&nbsp;&nbsp;<b style="color:pink;">房间列表:（当前在&nbsp;房间<?php echo isset($_GET['room_id'])&&intval($_GET['room_id'])>0 ? intval($_GET['room_id']):1; ?>）</b><br>
               &nbsp;&nbsp;&nbsp;&nbsp;<a href="/?room_id=1">房间1</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?room_id=2">房间2</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?room_id=3">房间3</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?room_id=4">房间4</a>
               <br><br>
               </div>
               <p class="cp"> www.heiehi.work  &copy;豫ICP备20007688号 Powered By:<a href="http://www.workerman.net/workerman-chat" target="_blank">workerman-chat</a></p>
	        </div>
